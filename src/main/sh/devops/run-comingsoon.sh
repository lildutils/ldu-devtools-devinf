...
_init() {
    ...
    portNumber=$(node -p -e "require('${PWD}/DEV-INF/configs.json').frontend.comingsoon.portNumber")

    version=$(node -p -e "require('${PWD}/DEV-INF/configs.json').frontend.comingsoon.version")
