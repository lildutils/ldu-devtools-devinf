...
_init() {
    ...
    redirectPortNumber=$(node -p -e "require('${PWD}/DEV-INF/configs.json').frontend.landing.redirectPortNumber")
    dockerPortNumber=$(node -p -e "require('${PWD}/DEV-INF/configs.json').frontend.landing.dockerPortNumber")
